...
qtnrRouters.delete("/:app_id/delete/v1.1", auth_verify_api_keys_tokens , (req, res)=>{
...
qtnrRouters.post("/init/v1.1", auth_verify_api_keys_tokens  , (req, res) => {
...
qtnrRouters.patch("/:app_id/app/setup_settings/v1.1", auth_verify_api_keys_tokens , (req,res)=>{
  var app_id = req.params.app_id;
...
// Create settings for quiz or survey ( remember this part => surv/quiz for used with /init route)
qtnrRouters.patch("/:app_id/app/edit/v1.1", auth_verify_generated_tokens ,  (req, res) => {
    var user = req.verified_user;
...
qtnrRouters.patch("/:app_id/settings/style/:process/v1.1", auth_verify_api_keys , (req, res) => {
    // Stylesheet
    var user = req.verified_user;
    var userType = req.is_creator;
...
qtnrRouters.patch("/:app_id/question/creation/v1.1"  , auth_verify_api_keys , (req,res)=>{
  var app_id = req.params.app_id ;
  var user = req.verified_user;
  var userType = req.is_creator;
...
qtnrRouters.patch("/:app_id/question/:process/v1.1" , question_answer_images.single("media_field") , auth_verify_api_keys , (req, res) =>{
...
// ==> Update answer
qtnrRouters.patch("/:app_id/question/:question_id/answer/media/edit/v1.1" , question_answer_images.single("media_src") ,  auth_verify_api_keys , (req , res)=>{
...
// Answers
qtnrRouters.patch("/:app_id/question/:question_id/answer/:process/v1.1" , question_answer_images.single("media_src") ,  auth_verify_api_keys , (req , res)=>{
...
qtnrRouters.post("/:app_id/application/:objects/v1.1" , auth_verify_api_keys , (req ,res )=>{
...
qtnrRouters.get("/:app_id/application/:objects/v1.1" , auth_api_keys_only , (req ,res )=>{
      var objects= req.params.objects ;
      var app_id = req.params.app_id ;
...
qtnrRouters.get("/:uid/applications/v1.1" , authenticate_keys_with_curr_status ,  (req,res) => {
...
qtnrRouters.get("/applications/list/v1.1" , auth_api_keys_only , (req , res )=>{
